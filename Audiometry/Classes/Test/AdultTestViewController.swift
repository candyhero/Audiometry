...
class AdultTestViewController: UIViewController, Storyboardable {
    // MARK: UI Components
    ...
    @IBOutlet weak var instructionLabvel: UILabel!
...
extension AdultTestViewController {
