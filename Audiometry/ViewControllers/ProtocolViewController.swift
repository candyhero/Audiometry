...
//------------------------------------------------------------------------------
    @IBAction func startPracticeTest(_ sender: UIButton) {
        startTesting(isPracticeMode: true, isAdult: true)
    }
    
    @IBAction func startAdultTest(_ sender: UIButton) {
        startTesting(isPracticeMode: false, isAdult: true)
    }
    
    @IBAction func startChildrenTest(_ sender: UIButton) {
        startTesting(isPracticeMode: false, isAdult: false)
    }
    
    func startTesting(isPracticeMode: Bool!, isAdult: Bool!) {
        ...
        if(isPracticeMode && (array_testFreqSeq.count > 1) ) {
